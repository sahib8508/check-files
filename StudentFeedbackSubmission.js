...
const handleFeedbackChange = async (e) => {
 ...
 const handleSubmitFeedback = async (e) => {
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      {feedbackType === "general" ? (
                        ...
                        <>
                          <option value="Book Availability">
                            Book Availability
                          </option>
                          <option value="Circulation">Circulation</option>
                          <option value="Digital Resources">
                            Digital Resources
                          </option>
                          <option value="Infrastructure">Infrastructure</option>
  ...
  placeholder={
    feedbackType === "general"
      ? "Please provide details about your feedback or complaint..."
      : "Please describe the library issue in detail..."
  }
/>
                    <small>
  ...
  type="submit"
  className="primary-button"
  disabled={submitting || validatingContent || !department || !feedback}
>
  {submitting ? (
    <>
      <span className="button-spinner"></span>
